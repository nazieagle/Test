(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        "use strict";
        var fs = require("fs"), utils = require("./utils"), scopeOptionWarned = false, _VERSION_STRING = require("../package.json").version, _DEFAULT_DELIMITER = "%", _DEFAULT_LOCALS_NAME = "locals", _REGEX_STRING = "(<%%|<%=|<%-|<%#|<%|%>|-%>)", _OPTS = ["cache", "filename", "delimiter", "scope", "context", "debug", "compileDebug", "client", "_with"], _TRAILING_SEMCOL = /;\s*$/, _BOM = /^\uFEFF/;
        ...
        function handleCache(options, template) {
            var fn, path = options.filename, hasTemplate = arguments.length > 1;
            if (options.cache) {
                if (!path) {
        ...
        Template.prototype = {
            createRegex: function () {
                ...
                var self = this, matches = this.parseTemplateText(), d = this.opts.delimiter;
        ...
        if (require.extensions) {
            require.extensions[".ejs"] = function (module, filename) {
                ...
                var options = {
                    filename: filename,
                    client: true
                }, template = fs.readFileSync(filename).toString(), fn = exports.compile(template, options);
